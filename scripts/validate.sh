...
grep -q 'key: kubernetes.io/hostname' "$render_dir/gpu.yaml"
grep -q 'hkh-k8s-staging-19' "$render_dir/gpu.yaml"
grep -q 'hkh-k8s-staging-20' "$render_dir/gpu.yaml"
grep -q 'hkh-k8s-staging-21' "$render_dir/gpu.yaml"
